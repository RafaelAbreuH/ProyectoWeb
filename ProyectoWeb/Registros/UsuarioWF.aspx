<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UsuarioWF.aspx.cs" Inherits="ProyectoWeb.Registros.UsuarioWF" %>
            ...
            <div class="card">
                ...
                <article class="card-body">
                    ...
                    <form>
                        ...
                        <asp:Image ID="UsuarioImage" runat="server" Height="285px" ImageUrl="~/Resources/Usuario.png" Width="211px" AlternateText="Imagen no disponible" ImageAlign="right" />
                        <div class="col-md-6 col-md-offset-3">
                            <div class="container">
                                <div class="form-group">
